...
| **17** | **LLM Conductor: бесплатный черновик + дешёвый verifier по порогу качества** | 🟡 **in progress** | этапы 1–2: settings API + OpenRouter catalog |
...
- Пункты 1–16 закрыты. **П.17 в работе**: этапы 1–2 реализованы, следующий этап — Admin UI для LLM-настроек.
